...
private:
	...
	std::condition_variable ready_cv; // Lets the game know when the thread manager has been properly reset.
	std::atomic<bool> ready; // This is used in conjunction with the ready CV to help prevent blocking indefinately when signaled in advance of waiting.
...
public:
	...
	set<GameObject*>* GetDeletionContainer();
