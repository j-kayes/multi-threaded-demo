...
const int kTankInitialHealth = 120;
...
const float kTurretInRangeEdgeFactor = 100.0f; // The edge length used by the pathfinding algorithm around turrets (so it can prefer paths out of range).

const float kShotSpeed = 200.0f;
const int kShotDamage = 4;